...
###    Rscript --vanilla param_filter_maxEE-truncQ.R SAMPLENAME
###
...
pathRES<- paste( pathDM, "/ec2m3.paper.dada2/CCR1/PDS/FilterTrim/MaxEE-TruncQ", sep="" )
...
param<-NULL
maxEE<-c( c(Inf,Inf), c(1,1), c(2,2), c(4,4), c(6,6) )
rm_phix<-c(T)
truncL<-c(c(0,0))
truncQ<-c(1,2,4,8,16)
