...
pathFQ <- paste( pathDM, "/ec2m3.paper.dada2/Data-ITMO16S", sep="" )
pathRES<- paste( pathDM, "/ec2m3.paper.dada2/ITMO16S/FilterTrim/Trunclen", sep="" )
...
maxEE<-c( c(2,2) )
rm_phix<-c(F)
truncL<-c(c(0,0), c(300,300), c(290,290), c(280,280), c(270,270), c(300,290), c(290,280) )
truncQ<-c(2)
