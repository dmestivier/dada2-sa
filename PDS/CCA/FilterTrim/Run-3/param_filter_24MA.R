...
fnFs <- paste( pathFQ, "/24MA_S64_L001_R1_001.fastq", sep="" )
fnRs <- paste( pathFQ, "/24MA_S64_L001_R2_001.fastq", sep="" )
...
#maxEE<-c( c(2,2) )
#rm_phix<-c(F)
#truncL<-c(c(0,0),c(245,230), c(240,230), c(235,230), c(250,225), c(250,220), c(250,215), c(250,250), c(245,245), c(240,240) )
#truncQ<-c(2)
