...
for( samplename in lof[, 1] )
{
	...
	pheatmap( percent, cluster_cols=F, cluster_rows=F, gaps_col=c(5), angle_col=c("315"), annotation_col=acols, show_colnames=F, color=mycol(100), filename=otfnALL, width=8.25, height=11.75, na_col="black" )

	pheatmap( percent[XX1:XX2,], cluster_cols=F, cluster_rows=F, gaps_col=c(5), angle_col=c("315"), annotation_col=acols, show_colnames=F, color=mycol(100), filename=otfnHIGH, width=8.25, height=11.75, na_col="black" )

	pheatmap( percent[XX3:nrow(percent),], cluster_cols=F, cluster_rows=F, gaps_col=c(5), angle_col=c("315"), annotation_col=acols, show_colnames=F, color=mycol(100), filename=otfnLOW, width=8.25, height=11.75, na_col="black" )
}
