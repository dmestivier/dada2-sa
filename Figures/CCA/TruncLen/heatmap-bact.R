...
pheatmap( percent, cluster_cols=F, cluster_rows=F, gaps_col=c(5), angle_col=c("315"), annotation_col=acols, show_colnames=F, color=mycol(100), filename="fig_truncLen-heatmap-full.pdf", width=8.25, height=11.75, na_col="black" )

pheatmap( percent[1:15,], cluster_cols=F, cluster_rows=F, gaps_col=c(5), angle_col=c("315"), annotation_col=acols, show_colnames=F, color=mycol(100), filename="fig_truncLen-heatmap-high.pdf", width=8.25, height=11.75, na_col="black" )

pheatmap( percent[45:nrow(percent),], cluster_cols=F, cluster_rows=F, gaps_col=c(5), angle_col=c("315"), annotation_col=acols, show_colnames=F, color=mycol(100), filename="fig_truncLen-heatmap-low.pdf", width=8.25, height=11.75, na_col="black" )
