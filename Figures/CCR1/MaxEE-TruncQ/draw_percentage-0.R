...
# list of filenames
listOfPDS = list.files( path="../../../PDS/CCR1/FilterTrim/MaxEE-TruncQ", pattern="_PDS.csv", full.names=T )
...
# Visualisation
ggplot( m, aes( x=PRM_TRUNCQ, y=pFiltered, fill=PRM_MAXEE)) + geom_boxplot() + ylim(0,100)

ggsave( "fig_maxEE-truncQ-left-filteredReads.pdf", scale = 1, width = 21, height = 29.7, units = c("cm"  ),   dpi = 300, limitsize = TRUE )
