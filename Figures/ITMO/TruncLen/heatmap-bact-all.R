...
# list of sample
lof  = read.csv("list-of-files-itmo16S", h=F, sep="\t" )
colnames(lof)[1] = c("sn")

# filename
pathFile   = "../../ITMO16S/FilterTrim/Trunclen/"
...
for( samplename in lof[, 1] )
{
	...
	# Selection subset
	L1      = which( pds$Trunclen %in% c("0-0", "270-270", "280-280", "290-290", "300-300" ) )
	#L1      = which( pds$Trunclen %in% c("TruncLen_0-0", "TruncLen_270-270", "TruncLen_280-280", "TruncLen_290-290", "TruncLen_300-300" ) )
	#L1      = which( pds$Trunclen %in% c("TruncLen_0-0", "TruncLen_270-270", "TruncLen_280-280", "TruncLen_290-290", "TruncLen_300-300" ) )
	pds     = pds[ L1, ]
	counts  = counts[ , L1 ]
